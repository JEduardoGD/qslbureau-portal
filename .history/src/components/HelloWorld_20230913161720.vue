      ...
      .then(data => {
        ...
        Swal.fire({
          ...
          html: '<table class="table"><tbody>' +
            ...
            `</tr><tr><td>QSL mas antigua capturada</td><td>${ moment(obj.oldest).format("DD MMM YYYY") }</td></tr>` +
            `</tr><tr><td>QSL mas reciente capturada</td><td>${ moment(obj.newest).format("DD MMM YYYY") }</td></tr>` +
            '</tbody></table>',
        })
      })
    }
