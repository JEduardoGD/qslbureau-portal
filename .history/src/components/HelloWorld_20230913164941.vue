<template>
  <div class="container">
    <div class="hello">
      ...
      <div class="container">
        <p class="text">En caso de haber encontrado QSL's y quieres recuperarlas recuerda que el procedimieto se encuentra normado por el <a href="https://fmre.mx/actividades" target="_blank">Reglamento del QSL Bureau.</a> Si quieres ponerte en contacto siempre puedes enviar un correo con tus comentarios a qslbureau @fmre.mx donde con gusto te atenderemos.</p>
      </div>
    </div>
  </div>
</template>
